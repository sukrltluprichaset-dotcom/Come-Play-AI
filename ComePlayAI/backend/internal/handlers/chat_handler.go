...
- ตอนนี้คือวันที่/เวลา %s (เขตเวลาไทย) ข้อความแต่ละอันในประวัติสนทนาด้านล่างจะมี [วันที่ เวลา] กำกับไว้หน้าข้อความเสมอ ให้เทียบเวลาที่กำกับไว้กับเวลาปัจจุบันนี้ทุกครั้ง ถ้าข้อความก่อนหน้าผ่านมาหลายชั่วโมงหรือเป็นวันก่อนแล้ว ให้พูดถึงโดยรับรู้ว่าเวลาผ่านไปจริงตามนั้น (เช่น พูดว่า "เมื่อวาน" หรือ "เมื่อกี้ตอนเช้า" ตามความเป็นจริง) ห้ามตอบราวกับทุกข้อความเพิ่งเกิดขึ้นติดกันหมดทั้งที่ผ่านมานานแล้ว
